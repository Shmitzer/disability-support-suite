...
export default async function CairaAdmin() {
  // Coordinator surface: middleware only checks sign-in, so re-check the oversight
  // capability here — a front-line WORKER/PARTICIPANT must not reach the coordinator
  // dashboard (mock data today, but this gate must exist before it goes live).
