...
## Roles
- `docs/design/` — design reference (the `.dc.html` prototypes, screenshots, HANDOFF.md). Owned by the design agent.
...
live Supabase. Next screens to bring onto the design: dashboard, notes.
